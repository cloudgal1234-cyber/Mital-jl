    ...
    <div className="flex min-h-screen bg-pearl-100">
      <aside className="hidden w-64 flex-col border-l border-nude-200 bg-pearl-50 p-6 md:flex">
        ...
        <nav className="flex flex-1 flex-col gap-1">
          ...
          <Link href="/admin/services" className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-ink/80 transition-colors hover:bg-nude-100">
            <Scissors className="h-4 w-4" /> טיפולים ומחירים
          </Link>
        </nav>
